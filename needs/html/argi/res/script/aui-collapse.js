                ...
                for(var i=0;i<collapseHeader.length;i++){
                    (function(e){
                        collapseHeader[e].onclick = function(){
                            if(collapseHeader[e].parentNode.nextSibling.nextElementSibling.className.indexOf("aui-collapse-content") > -1){
                                if(collapseHeader[e].parentNode.nextSibling.nextElementSibling.className.indexOf("aui-show") > -1){
                                    collapseHeader[e].parentNode.nextSibling.nextElementSibling.classList.remove("aui-show");
                                    ...
                                    collapseHeader[e].parentNode.nextSibling.nextElementSibling.classList.toggle("aui-show");

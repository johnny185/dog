...
var newContent = "<table class='tablestyle0'>" +
						...
						"<td class='col-7'>" +
							"<a href='javascript:void(0);''>" +
								"<table class='tablestyle0-record'>" +
									"<tr><th>记工单号: </th><td>占位</td></tr>" +
									"<tr><th>采收工单号: </th><td>占位</td></tr>" +
									"<tr><th>创建人: </th><td>占位</td></tr>" +
									"<tr><th>创建时间: </th><td>占位</td></tr>" +
								"</table>" +
							"</a>" +
						"</td>" +
	...
	function pullDownAction () {
		setTimeout(function () {	// <-- Simulate network congestion, remove setTimeout from production!
			var el, li, i;
			el = document.getElementById('harvestRecordListContainer');

...
var request = function request(option) {
    ...
    var _custom = assign({}, _default, option);
    ...
    if (_custom.type != 'get' && _custom.data) {
    ...
    api.ajax({
        ...
        if (ret) {
            if (ret.status !== 'ok') {
                ...
                _custom.success && _custom.success(ret);
            }
        } else {
            if (_custom.error) {
                _custom.error(err);
...
var startOfWeek = __webpack_require__(92)
...
var startOfISOWeek = __webpack_require__(73)
...
var historyStr = '\n{{~it :value:index}}\n<ul>\n  <li>\n    <p>\u57FA\u5730</p>\n    <p>{{=value.farmName}}</p>\n  </li>\n  <li>\n    <p>\u4F5C\u7269</p>\n    <p>{{=value.catalogName}}{{=value.categoryName}}</p>\n  </li>\n  <li>\n    <p>\u8BB0\u5DE5\u65E5\u671F</p>\n    <p>{{=value.recordDate}}</p>\n  </li>\n  <li>\n    <p>\u89C4\u683C\u6570\u91CF</p>\n    <p><span>{{=value.standardNumber}}</span><span>{{=value.numeratorName}} {{?value.denominatorName!=\'\'}} / {{=value.denominatorName}} {{?}}</span></p>\n  </li>\n  {{~value.harvestWorkRecordDetailsVoList :wr}}\n  <li>\n    <p>{{=wr.gradeName}}</p>\n    <p><span>{{=wr.harvestNumber}}</sapn><span>{{=wr.unitName}}</span></p>\n  </li>\n  {{~}}\n    </ul>\n  {{~}}\n      ';
var $historyItem = $api.byId('historyRecord');
var tempFn = _dot2.default.template(historyStr);
//	打开搜索区域
window.checkViewOpen = function () {
    $("#content .searchView").slideDown(300);
};
var isAndroid = /android/gi.test(navigator.appVersion);
if (!isAndroid) {
    $("#content .searchView").css('top', '80px');
}
//	关闭搜索区域
window.checkViewClose = function () {

    $("#content .searchView").slideUp(300);
};
//初始化
window.search = function (workerId) {
    var startTime = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
    var endTime = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
    ...
    var url = '/recordworkorder/query_work_order_history';
    _Ajax2.default.get(url, pageParam, function (result) {
        var historyList = result.data || [];
        historyList.forEach(function (it) {
            var pos = it.recordDate.lastIndexOf(':');
            it.recordDate = it.recordDate.substr(0, pos);
        });
        $api.html($historyItem, tempFn(historyList));
    });
};
...
window.apiready = function () {
    ...
    $("#content .searchView .submitBtn").click(function (ev) {
        ...
        var start = $('#start').val() + ":00";
        var end = $('#end').val() + ":00";
        // api.pageParam.workerId
        search(api.pageParam.workerId, start, end);
    });
    search(api.pageParam.workerId);
};
...
var getDayOfYear = __webpack_require__(87)
var getISOWeek = __webpack_require__(91)
var getISOYear = __webpack_require__(83)
var parse = __webpack_require__(55)
...
var parse = __webpack_require__(55)
var startOfYear = __webpack_require__(88)
var differenceInCalendarDays = __webpack_require__(89)
...
var startOfDay = __webpack_require__(90)
...
var parse = __webpack_require__(55)
var startOfISOWeek = __webpack_require__(73)
var startOfISOYear = __webpack_require__(93)

...
var newContent = "<table class='tablestyle0'>" +
						...
						"<td class='col-7'>" +
							"<a href='javascript:void(0);''>" +
								"<table class='tablestyle0-transport'>" +
									"<tr><th>运输单号: </th><td>占位</td></tr>" +
									"<tr><th>采收单号: </th><td>CSGD201601010001</td></tr>" +
									"<tr><th>装车负责人: </th><td>占位</td></tr>" +
									"<tr><th>创建时间: </th><td>2016-06-20 12:35:02</td></tr>" +
								"</table>" +
							"</a>" +
						"</td>" +
	...
	function pullDownAction () {
		setTimeout(function () {	// <-- Simulate network congestion, remove setTimeout from production!
			var el, li, i;
			el = document.getElementById('harvestTransportListContainer');
